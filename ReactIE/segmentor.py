...
class TopicSegmentor:
    def __init__(self, device='cuda:0', keywords=None):
        ...
        self.keywords = [
                ...
                'afford', 'affords', 'affordied', 'affording',
    ...
    def segment(self, context):
        """
            file: path to the paper file, e.g., 'data/Copper_Acetate.json'
            section: list of section name, e.g., ['introduction', 'results and discussion']
        """
        ### flatten sentences ###
        pos = []
        sentences = []
